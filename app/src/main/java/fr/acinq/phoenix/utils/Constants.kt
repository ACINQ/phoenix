...
object Constants {
  ...
  const val PAYMENT_RECEIVED_NOTIFICATION_CHANNEL_ID = "${BuildConfig.APPLICATION_ID}.PAYMENT_RECEIVED_NOTIF"
  const val PAYMENT_RECEIVED_NOTIFICATION_ID = 81320
  const val FCM_NOTIFICATION_CHANNEL_ID = "${BuildConfig.APPLICATION_ID}.FCM_NOTIF"
  const val FCM_NOTIFICATION_ID = 81321
