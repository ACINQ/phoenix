...
sealed class Screen(val route: String) {
    ...
    data object InitWalletGraph : Screen("initwallet_graph") {
    ...
    // this business navgraph is the lifecycle owner for the payments view model
    data object BusinessNavGraph : Screen("business_graph") {
        ...
        data object ResetWallet: Screen("resetwallet")
