...
class BusinessManager {
	...
	///
	public private(set) var business: PhoenixBusiness
	...
	public func reset() {
		...
		// - MultiBusinessManager should create a new BusinessManager instance instead
		// - change `business` instance from `var` to `let`
	...
	func loadWallet(
		...
		LockState.shared.walletExistence = .exists(walletId: walletId)
	}
