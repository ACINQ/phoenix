...
struct PaymentCell : View {
	...
	func line2() -> String {
		...
		} else if let liquidity = payment as? Lightning_kmpInboundLiquidityOutgoingPayment {
	...
	func line2HasExtraInfo() -> Bool {
		...
		if info.payment is Lightning_kmpInboundLiquidityOutgoingPayment {
	...
	func isLiquidityWithFeesDisplayedElsewhere() -> Bool {
		...
		if let liquidity = info.payment as? Lightning_kmpInboundLiquidityOutgoingPayment {
