...
enum class InAppNotifications(val priority: Int, val messageResId: Int, val imageResId: Int, val actionResId: Int?) {
  ...
  MEMPOOL_HIGH_USAGE(2, R.string.inappnotif_mempool_high_usage, R.drawable.ic_alert_triangle, R.string.inappnotif_mempool_high_usage_action),
  ...
  PREPARE_WALLET_MIGRATION(1, R.string.inappnotif_prepare_migration, R.drawable.ic_fire, R.string.inappnotif_prepare_migration_action),
}
