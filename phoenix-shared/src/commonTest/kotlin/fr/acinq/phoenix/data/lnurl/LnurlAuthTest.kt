...
class LnurlAuthTest {
    ...
    private val wallet = Wallet(seed, Chain.Testnet)
    ...
    fun test_default_scheme() {
        ...
        val linkingKey = LnurlAuth.getAuthLinkingKey(wallet, auth.initialUrl, LnurlAuth.Scheme.DEFAULT_SCHEME)
    ...
    fun test_android_legacy_scheme() {
        ...
        val linkingKey = LnurlAuth.getAuthLinkingKey(wallet, auth.initialUrl, LnurlAuth.Scheme.ANDROID_LEGACY_SCHEME)
