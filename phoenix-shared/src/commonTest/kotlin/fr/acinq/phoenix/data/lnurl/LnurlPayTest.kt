...
class LnurlPayTest {
    ...
    fun parse_response_text() {
        runBlocking {
            ...
            assertIs<LnurlPay.Intent>(lnurl)
            assertEquals(1.msat, lnurl.minSendable)
            assertEquals(8_156_723_209_123.msat, lnurl.maxSendable)
            assertEquals(8, lnurl.maxCommentLength)
            assertEquals("'ç!@#\$%^&*()_+{}", lnurl.metadata.plainText)
            assertEquals(Url("https://lnurl.fiatjaf.com/lnurl-pay/callback/0abd4cdb7b0b62e50d5a3e8704287049b3a6dff50f40ff5db821955cca00791b"), lnurl.callback)
        }
    }
